...
{
    internal class CircuitProcessor : DeviceProcessor
    {
        ...
        public CircuitProcessor(XElement node, GroupProcessor processor) : base(node, processor) { }
